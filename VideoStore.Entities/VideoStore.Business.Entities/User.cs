...
namespace VideoStore.Business.Entities
{
    ...
    public partial class User: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<Media> Medium
        {
            get
            {
                if (_medium == null)
                {
                    _medium = new TrackableCollection<Media>();
                    _medium.CollectionChanged += FixupMedium;
                }
                return _medium;
            }
            set
        ...
        private TrackableCollection<Media> _medium;
        ...
        private void FixupMedium(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Media item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Medium", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (Media item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Medium", item);
                    }
                }
            }
        }
