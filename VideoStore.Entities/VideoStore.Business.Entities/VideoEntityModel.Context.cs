...
namespace VideoStore.Business.Entities
{
    public partial class VideoStoreEntityModelContainer : ObjectContext
    {
        ...
        {
            get { return _recommendations  ?? (_recommendations = CreateObjectSet<Recommendation>("Recommendations")); }
        }
        private ObjectSet<Recommendation> _recommendations;
    
        public ObjectSet<LikeMatching> LikeMatchings
        {
            get { return _likeMatchings  ?? (_likeMatchings = CreateObjectSet<LikeMatching>("LikeMatchings")); }
        }
        private ObjectSet<LikeMatching> _likeMatchings;
